...
class TestTaskContextTypeAnnotation:
    ...
    def test_task_context_can_be_set_to_none(self):
        ...
        task = Task(
            description="Test task", expected_output="Test output", context=None
        )
    ...
    def test_task_context_can_be_set_to_task_list(self):
        ...
        task3 = Task(
            description="Task 3", expected_output="Output 3", context=[task1, task2]
        )
    ...
    def test_task_context_type_annotation_includes_not_specified(self):
        ...
        if origin is not None:
            ...
            assert any(
                "_NotSpecified" in str(arg) or arg is _NotSpecified for arg in args
    ...
    def test_task_context_distinguishes_not_passed_from_none(self):
        ...
        task_empty_list = Task(
            description="Test task", expected_output="Test output", context=[]
        )
    ...
    def test_task_context_usage_in_crew_logic(self):
        ...
        task_with_none = Task(
            description="Task 2", expected_output="Output 2", context=None
        )
        task_with_empty_list = Task(
            description="Task 3", expected_output="Output 3", context=[]
        )
